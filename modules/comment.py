...
def build_comment(base,scoring,aad=None,related=None,ti=None,ip_baseline=None,mde=None,ueba=None,file_insights=None,mcas=None):
    ...
    score=scoring.get("TotalScore",0);degraded=bool(base.get('EnrichmentWarnings') or aad.get('RiskUserAvailable') is False or aad.get('RiskEventsAvailable') is False or related.get('EnrichmentWarnings') or ip_baseline.get('EnrichmentWarnings') or ueba.get('EnrichmentWarnings'))
