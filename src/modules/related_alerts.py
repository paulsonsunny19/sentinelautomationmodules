...
def query_related_alerts(request: RelatedAlertsRequest) -> list[dict[str, Any]]:
    ...
    # Column names are selected only from a fixed allow-list. Entity values are passed
    # as KQL parameters rather than concatenated into the query text.
    query = f"""
